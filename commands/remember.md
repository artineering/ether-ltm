---
description: Pin a memory to the LTM (declaration/pin, w=5)
---
Use the Bash tool to run exactly this, and nothing else:

    python "${CLAUDE_PLUGIN_ROOT}/scripts/ether_record.py" remember --i-am-the-principal "$ARGUMENTS"
...
Acknowledge in one line, quoting the event id.
